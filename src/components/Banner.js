...
const Banner = () => {
      ...
      const urlHome =
            ...
            document.location.pathnamen === '/home';
      const ImgBanner = urlHome ? imgBannerHome : imgBannerABout;
      const AltBanner = urlHome
            ? 'Image illustrant un paysage de mer'
            : 'Image illustrant une montagne';
      const textBannerComputer = urlHome ? (
            <p className="bannerHomeOrAbout__textComputer">
                  Chez vous, partout et ailleurs
            </p>
      ) : null;
      const textBannerSmarphone = urlHome ? (
      ...
      const classNameHome = urlHome
            ? 'bannerHomeOrAbout__Img'
            : 'bannerHomeOrAbout__Img--home';
